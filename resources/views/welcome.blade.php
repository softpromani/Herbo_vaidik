                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="pa-product-box">
                        ...
                        <div class="pa-product-cart">
                            <a href="{{url('/enquiry-us')}}" class="btn" style="background: #2C5E1A; color:#fff; width:100%;">Enquire Now
                            </a>
                            {{-- <ul>
                                <li>
                                    <a href="#">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pa-blog-box">
                       <a href="{{route('singleBlog',$blog->slug)}}"> <img src="{{asset('Blogs/'.$blog->image)}}" alt="image" class="img-fluid" style="height:250px; width:348px;"></a>
