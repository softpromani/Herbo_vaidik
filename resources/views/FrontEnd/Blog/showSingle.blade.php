        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="pa-blog-box">
                    <img src="{{asset('/Blog/'.$blog->image)}}" alt="image" class="img-fluid" style="height:400px;width:728px;">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="pa-pro-wid-img">
                                    <img src="{{asset('/Blog/'.$bloga->image)}}" alt="image" class="img-fluid" style="height:54px; width:58px;">
                                </div>
